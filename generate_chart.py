...
ax.set_xlim(low_rpm, high_rpm)
ax.set_ylim(low_diameter, high_diameter)
...
plt.figtext(0.23, 0.04, "Recommended speeds:", wrap=True, horizontalalignment="left", fontsize=10)
plt.figtext(0.4, 0.04, "Aluminium 150-250 m/min", wrap=True, horizontalalignment="left", fontsize=10)
plt.figtext(0.6, 0.04, "Steel 90-150 m/min", wrap=True, horizontalalignment="left", fontsize=10)
plt.figtext(0.4, 0.02, "Stainless steel 45-75 m/min", wrap=True, horizontalalignment="left", fontsize=10)
plt.figtext(0.6, 0.02, "Brass 120-250 m/min", wrap=True, horizontalalignment="left", fontsize=10)
